    ...
    <div className="p-8">
      ...
      <form onSubmit={handleCreate} className="mb-4 flex gap-2">
        <input
          ...
          required
          className="border p-2 rounded-xl bg-[var(--glass-bg)] backdrop-blur-lg backdrop-saturate-200 transition focus:ring-2 focus:ring-[var(--accent)] text-[var(--foreground)]"
        />
        <input
          placeholder="Name"
          value={newUser.name}
              ...
              <tr>
                <th className="p-2">
                  <span className="inline-flex items-center gap-1">
                    ID
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5 inline-block align-middle">
                ...
                <React.Fragment key={u.id}>
                  ...
                  >
                    ...
                    <td className="p-2 text-center">
                      <button
                        className="px-4 py-1 rounded-full bg-[var(--glass-bg)] border border-[var(--border)] shadow transition-all font-semibold text-[var(--foreground)] mr-2
                      ...
                      <button
                        className="px-4 py-1 rounded-full bg-[var(--glass-bg)] border border-[var(--border)] shadow transition-all font-semibold text-[var(--foreground)]
      ...
      {editingUser && (
        <div className="fixed inset-0 flex items-center justify-center z-50" style={{
          ...
          <form
            ...
            className="bg-[var(--glass-bg)] p-8 rounded-2xl shadow-2xl glass-border flex flex-col gap-2 min-w-[300px] backdrop-blur-lg backdrop-saturate-200"
            style={{
          ...
          >
            <h3 className="text-lg font-bold mb-2 text-[var(--foreground)]">Edit User</h3>
            <input
              placeholder="Email"
            ...
            <div className="flex gap-4 mt-4 justify-center">
              <button
                type="submit"
                className="px-6 py-2 rounded-full bg-[var(--glass-bg)] border border-[var(--border)] shadow font-semibold text-[var(--foreground)] transition-all focus:outline-none
                  hover:border-blue-500 hover:shadow-[0_0_0_2px_#3b82f6,0_4px_32px_0_rgba(0,0,0,0.12)]"
                style={{
                  backdropFilter: "blur(8px) saturate(180%)",
                  WebkitBackdropFilter: "blur(8px) saturate(180%)",
                  boxShadow: "0 4px 32px 0 rgba(0,0,0,0.08)",
              ...
              <button
                type="button"
                className="px-6 py-2 rounded-full bg-[var(--glass-bg)] border border-[var(--border)] shadow font-semibold text-[var(--foreground)] transition-all focus:outline-none
                  hover:border-red-500 hover:shadow-[0_0_0_2px_#ef4444,0_4px_32px_0_rgba(0,0,0,0.12)]"
                style={{
                  backdropFilter: "blur(8px) saturate(180%)",
                  WebkitBackdropFilter: "blur(8px) saturate(180%)",
                  boxShadow: "0 4px 32px 0 rgba(0,0,0,0.08)",
